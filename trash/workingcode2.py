...
def EnemyMovement():
		...
		if x==1:
			...
			#	pos[0]=-1
			if(pos[0]!=-1 and pos[0]-54>=0 and gameArray[(pos[0]-54)]!=1 and gameArray[pos[0]-54]!=4 and gameArray[pos[0]-54]!=2):
			...
			#	gameArray[pos[0]]=0
			#	pos[0]=-1
			if(pos[0]!=-1 and pos[0]+54<(54*54+54) and gameArray[pos[0]+54]!=1 and gameArray[pos[0]+54]!=4 and gameArray[pos[0]+54]!=2):
				gameArray[pos[0]+54]=8
				gameArray[pos[0]]=0
				pos[0]+=54
		elif x==3:
			...
			#	gameArray[pos[0]]=0
			#	pos[0]=-1
			if(pos[0]!=-1 and pos[0]%54!=53 and gameArray[pos[0]+1]!=1 and gameArray[pos[0]+1]!=4 and gameArray[pos[0]+1]!=2 and pos[0]%54!=53):
				gameArray[pos[0]+1]=8
				gameArray[pos[0]]=0
				pos[0]+=1
		elif x==4:
...
def Render():
	...
	print(colored('X','red')),
	print(colored('X','red'))
	print("lives[0] Remaining:", lives[0])
...
def UpdateBombs():
	for i in activeExplosions:
		gameArray[i] += 1
		if gameArray[i] >= 16 and gameArray[i]<=32:
			if i in brokenBoxes:
				rand = random.random()
				if rand < 0.1:
					gameArray[i] = 5
	...
	for i in activeBombs:
		gameArray[i] += 1
		if gameArray[i] >= 32 and gameArray[i]<35:
			Explode(i)
